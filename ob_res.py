...
class MainWindow:
    def __init__(self, root, cnx) -> None:
            ...
            try:
                ...
                for elem in cur.stored_results():
                    ...
                    for elem in datalist:
                        strlist.append(self.Ka1650984115118584(elem, table_name))
                datavar.set(strlist)
        ...
        tablebox.bind("<<ComboboxSelected>>", lambda _: WN16509841151165898())
        tablebox.current(0)
        WN16509841151165898()

    def gf1650984115117587(self):
        if self.user == None:
    ...
    def BW1650984115117587(self, book_id):
        top = Toplevel()
    ...
    def tD1650984115117587(self, book_id):
        top = Toplevel()
    ...
    def al1650984115117587(self):
        ...
        def UB1650984115117587(*args):
            info["text"] = "Enter name"
        name_entry.bind("<FocusIn>", name_bind)
        def eb1650984115117587(*args):
    ...
    def cv1650984115117587(self, table_name: str):
    ...
    def ZK1650984115117587(self, table_name, params: List[str]):
        top = Toplevel()
    ...
    def mc1650984115117587(self, table_name, params: List, data: List):
        top = Toplevel()
    ...
    def Ka1650984115118584(self, data, table_name):
        params = self.cv1650984115117587(table_name)
        params.insert(0, "id")
    ...
    def RZ1650984115118584(self):
        ...
        def Kw1650984115118584(*args):
            table_name = tablebox.get()
            self.ZK1650984115117587(table_name, self.cv1650984115117587(tablebox.get()))
        insert = ttk.Button(toolframe, text="Insert", command=on_insert_button)
        insert.grid(column=0, row=1, sticky=(W, E))

        def Qk1650984115118584(*args):
            selection = data.curselection()
            if len(selection) == 0:
                return
            index = selection[0]
            table_name = tablebox.get()            
            self.mc1650984115117587(table_name, self.cv1650984115117587(tablebox.get()), datalist[index])
        update = ttk.Button(toolframe, text="Update", command=on_update_button)
        update.grid(column=1, row=1, sticky=(W, E))

        def NM1650984115118584(*_):
            selection = data.curselection()
            if len(selection) == 0:
                return
            index = selection[0]
        ...
        refresh = ttk.Button(toolframe, text="Refresh", command=lambda *_: WN16509841151165898())
        refresh.grid(column=1, row=2, sticky=(W, E))  

        def xA1650984115118584(*_):
            selection = data.curselection()
            if len(selection) == 0:
                return
            index = selection[0]
            ...
            if table_name != "book":
                return
            self.QQ1650984115118584(table_name, id, "author")
        ...
        def ST1650984115118584(*_):
            ...
            if table_name != "book":
                return
            self.QQ1650984115118584(table_name, id, "series")
    ...
    def QQ1650984115118584(self, table_name1: str, id1, table_name2: str):
        top = Toplevel()
